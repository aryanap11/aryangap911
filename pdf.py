...
def process_pdf(uploaded_file):
    try:
        ...
        for page_number in range(len(pdf_document)):
            ...
            zoom = 1.0  # 2.0 will double the resolution (increase DPI)
...
def main_app():
    ...
    st.write("Easily transform PDFs with dark backgrounds into print-friendly format")
    st.write("Thank me if it was useful to you through the 'Connect with Me' section on sidebar!")
